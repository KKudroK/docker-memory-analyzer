...
from .core import Unsupported, UnsupportedLayout, InconsistentData, member, capture, dereference, observation
from .namespaces import namespace_inum as read_namespace_inum
...
def kernel_id(value, *, require_member_api=False):
    wrapped = value.has_member('val') if require_member_api or hasattr(value, 'has_member') else False
